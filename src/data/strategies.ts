...
export const STRATEGIES: Strategy[] = [
  {
    ...
    rr: 2.2,
    longDescription:
      "Breakout & Retest waits for price to close through a clearly defined level, then returns to retest that same level as new support or resistance before continuing. The retest filters out fake breakouts and gives you a tight, defined stop just on the other side of the level. Works best in trending environments and when the breakout is driven by volume or session open momentum.",
    playbook: [
      {
        title: "Setup",
        items: [
