        ...
        {filtered.map((d) => {
          ...
          return (
            <button
              ...
              className="text-left rounded-xl border border-border/60 bg-card hover:border-primary/40 hover:bg-primary/5 transition p-5 flex flex-col gap-3 group"
            >
              <div className="flex items-start justify-between gap-2">
                ...
                <span className="text-[10px] tracking-tight px-2 py-1 rounded border border-primary/30 text-primary bg-primary/10">
                  {pct}%
                </span>
              </div>
    ...
    <div>
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        <div className="flex flex-wrap gap-1.5 shrink-0">
          <button onClick={shuffle} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium border border-border/60 hover:border-primary/40 hover:text-primary transition">
            <Shuffle className="h-3.5 w-3.5" /> Shuffle
          </button>
          <button onClick={reset} className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-medium border border-border/60 hover:border-primary/40 hover:text-primary transition">
      ...
      <div className="flex items-center justify-between gap-2 mt-6">
        <button
          onClick={prev}
          disabled={idx === 0}
          className="inline-flex items-center gap-1 px-4 py-2 rounded-xl border border-border/60 text-sm disabled:opacity-40 hover:border-primary/40 hover:text-primary transition"
        >
        ...
        <div className="flex gap-2">
          <button
            onClick={() => mark("review")}
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium border border-amber-500/40 text-amber-400 hover:bg-amber-500/10 transition"
          >
            <X className="h-4 w-4" /> Review
          </button>
          <button
            onClick={() => mark("known")}
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium border border-bull/40 text-bull hover:bg-bull/10 transition"
          >
