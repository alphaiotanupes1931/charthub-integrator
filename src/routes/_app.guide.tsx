...
const STEPS = [
  ...
  { icon: Activity,      title: "Trade from the chart",  body: "The Broker page embeds TradingView with a built-in broker terminal. Connect OANDA, Tradovate, IBKR and execute right from the chart." },
