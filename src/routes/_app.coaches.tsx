...
import { Bot, BarChart2, Target, GraduationCap, Minus, HeartPulse, CheckCircle2, Volume2, Sparkles, Loader2, Square, X, Info } from "lucide-react";
      ...
      <div className="rounded-xl border-2 border-primary/60 bg-primary/[0.03] p-6 mb-8">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className={`h-11 w-11 rounded-2xl flex items-center justify-center ${activeCoach?.iconBg ?? "bg-muted text-primary"}`}>
              {activeCoach ? (
            ...
            <div>
              <div className={`inline-block rounded-xl px-2.5 py-1 ${activeCoach?.nameBg ?? ""} ${activeCoach?.nameText ?? ""}`}>
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className={`flex-1 min-w-0 rounded-xl px-2.5 py-1 ${c.nameBg}`}>
                ...
                <button
                  ...
                  className="h-9 w-9 rounded-xl border border-border/60 hover:border-primary/40 hover:text-primary flex items-center justify-center shrink-0"
                >
              ...
              <div className="flex items-center gap-2 text-xs">
                ...
                <span className="rounded border border-border/60 bg-background px-2 py-0.5">{c.tone}</span>
                {voice && (
                  <span className="rounded border border-border/60 bg-background px-2 py-0.5 text-muted-foreground truncate">
                    {voice.label}
                  </span>
                )}
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => setDetail(c)}
                  className="inline-flex items-center justify-center gap-1.5 rounded-xl border border-border/60 bg-background px-3 py-2 text-xs font-medium text-muted-foreground hover:text-foreground hover:border-primary/40 transition"
      ...
      >
        <div className="flex items-start justify-between gap-3 p-5 border-b border-border/60">
          <div className="flex items-center gap-3 min-w-0">
            <div className={`h-12 w-12 rounded-2xl flex items-center justify-center shrink-0 ${coach.iconBg}`}>
              <Icon className="h-6 w-6" />
            </div>
            <div className="min-w-0">
              <div className={`inline-block rounded-xl px-2.5 py-1 ${coach.nameBg}`}>
          ...
          <button
            onClick={onClose}
            aria-label="Close"
            className="h-8 w-8 rounded-xl text-muted-foreground hover:text-foreground hover:bg-accent/40 flex items-center justify-center shrink-0"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
        ...
        <div className="flex items-center justify-end gap-2 p-5 border-t border-border/60">
          <button onClick={onClose} className="rounded-xl px-3 py-2 text-sm text-muted-foreground hover:text-foreground">Close</button>
          <button
            onClick={onSelect}
            disabled={isActive}
